...
func TestDomain_ValidIsClosed(t *testing.T) {
	...
	for _, d := range []canonical.Domain{"", "arqtos.act-body", "act-body.v1", "arqtos.act-body.v2", "arqtos.resolved-config", "arqtos.resolved-config.v2", "arqtos.config-body", "arqtos.config-body.v2"} {
		if d.Valid() {
