...
const (
	...
	// CapBindAuth declares that this connector accepts host-supplied
	// bootstrap material via [AuthBinder.BindAuth]. Token and two-key
	// profiles use that same operation. A connector that declares it MUST
